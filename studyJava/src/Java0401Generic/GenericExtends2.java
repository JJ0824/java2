...
class Test {
    void method1(Goods2<E> g) {
    } // T를 사용할 수 없음. 구체적인 클래스 명시

    void method2(Goods2<?> g) {
    } // 어떤 클래스던 가능

    void method3(Goods2<? extends F> g) {
    } // F와 F의 자식클래스 가능

    void method4(Goods2<? super F> g) {
    } // B와 B의 부모클래스 가능
}
