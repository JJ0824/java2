...
public class ArrayList_3 {
    public static void main(String[] args) {
        ...
        // #9. isEmpty 요소가 있는지 없는지 확인할 때 사용. 비었으면 true리턴
        ...
        // new Integer[0]는 0의 length를 가진 배열을 만드는 게 아니라
        // aList3.size() 와 같은 배열의 크기로 만들라는 약속!!
        ...
        while(iterator.hasNext()) {
            ...
            // 그래서 while반복문 내에 iterator의 증가코드가 필요 없음
