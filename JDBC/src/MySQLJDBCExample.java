...
public class MysqlJdbcExample {
    ...
    public void getEmployees_2() {
        // 2) Map으로 동적 데이터 처리
        // 쿼리결과의 구조가 자바 클래스와 일치하지 않고 재사용 예정이라면
    ...
    // #5. 주문 기록이 없는 고객의 고객번호와 고객회사명 조회
    public void getCustomersNotOrder() {
        String query = "select 고객.고객번호, 고객.고객회사명 from 고객"
                + " left join 주문 on 고객.고객번호 = 주문.고객번호 where 주문.고객번호 is null";
