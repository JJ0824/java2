...
PK : 테이블의 각 행을 고유하게 식별하는 컬럼. 테이블당 오직 한 개만 가능
	 자동으로 unique와 not null 속성을 가짐. 인덱스를 자동 생성
unique : 테이블에서 고유한 값 보장. null 속성 가짐.
		 인덱스를 자동 생성 X, 테이블 내에서 여러 개의 unique 컬럼을 가질 수 있음.
 */
...
insert into 영화
values('MV001', 'Diablo', '액션', 'Sam', 'Sam', '1999-09-09', null);
